...
import { Page } from "@nativescript/core/ui/frame";
...
export class HelloWorldModel extends Observable {
	...
	public itemTapped(args) {
		...
		// You can use `https://maps.googleapis.com/maps/api/place/details/json?placeid=${args.selectedItem.place_id}&key=${API_KEY}` for detailed place infos
	}
	...
	showNewThings() {
		...
		(<any>this.page.getViewById("myfilter")).show();
	}
